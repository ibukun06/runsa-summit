...
export default function App() {
  ...
  const handleRegister = async form => {
    ...
    if (regs.length >= 700) { alert("Registration is now closed. The maximum number of delegates (450) has been reached."); return; }
...
const DEPARTMENTS = [
  ...
  "Nursing Science", "Petroleum Chemistry", "Philosophy", "Physical Sciences", "Physics with Electronics", 
...
function StatCards({ total, checkedIn, pending, onFilterCheckin, T }) {
  ...
  const animSpots    = useCountUp(700 - total, 900);
  const stats = [
    { label:"Total Registered", value:animTotal,   raw:total,     max:700,       accent:BRAND.gold,    click:null,        hint:"" },
    ...
    { label:"Spots Remaining",  value:animSpots,   raw:600-total, max:700,       accent:BRAND.navyMid, click:null,        hint:"" },
  ];
  return (

  ...
  return (
    <>
      ...
      <main style={{ minHeight:"calc(100vh - 64px)" }}>
        ...
        {view === "admin" && <AdminView regs={regs} T={T} />}
      </main>
      ...
      <style>{`
        ...
        @media (max-width: 640px) { .hide-on-mobile { display:none !important; } .show-mobile { display:flex !important; } }
      `}</style>
    </>
  );
}
  ...
  if (!unlocked) return (
    <div style={{ maxWidth:1100, margin:"0 auto", padding:"60px 20px", display:"flex",
      ...
      <div style={{ width:"100%", maxWidth:380, background:T.surface,
        ...
        <p style={{ fontSize:11, color:T.textMuted, marginTop:14 }}>Default PIN: RUNSA2026</p>
      </div>
    </div>
  );
          ...
          <tbody>
            ...
            {filtered.map((r, i) => (
              <tr key={r.id} style={{
                ...
                <td style={{ padding:"12px 16px", fontWeight:600, color:T.text, whiteSpace:"nowrap" }}>
                  {r.name}
                </td>
                <td style={{ padding:"12px 16px", fontSize:13, color:T.textMuted }} className="hide-mobile">
                  {r.institution}
                </td>
                <td style={{ padding:"12px 16px", fontSize:13, color:T.textMuted }} className="hide-mobile">
                  {r.level}
